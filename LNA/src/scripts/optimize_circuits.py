...
def write_generation(output_root, generation, population, all_records):
...
def optimize(args):
    ...
    planned_simulations = args.population_size + args.offspring_size * args.generations
    valid_seed_designs = (
    ...
    print(
        "[optimize_circuits] planned simulations: "
        f"{planned_simulations:,} = population {args.population_size:,} + "
    ...
    for generation in range(1, args.generations + 1):
        print(f"[optimize_circuits] generation {generation}/{args.generations}", flush=True)
        ...
        write_generation(args.output_root, generation, population, list(optimizer.cache.values()))
